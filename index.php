  ...
  <body>
          ...
          <div class="item item-1">
            <div class="img-fill">
                <div class="text-content">
                  ...
                  <p>This website is created by Mohit Pansare as the <em>Task1</em> of <br><em>the Web development internship @ The Sparks Foundation</em>.</p>
    ...
    <div class="sub-footer">
      <div class="container">
        <div class="row">
          <div class="col-md-12">
            <p>Copyright &copy; 2020 Sparks Bank Ltd.
